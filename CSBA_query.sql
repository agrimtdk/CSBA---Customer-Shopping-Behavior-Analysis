...
select item_purchased, ROUND(AVG(review_rating::numeric), 2) as avg_rr from customer
...
round(sum(purchase_amount), 2) as total_rvn
from customer
group by (subscription_status)
order by total_rvn, avg_purchase_amnt
